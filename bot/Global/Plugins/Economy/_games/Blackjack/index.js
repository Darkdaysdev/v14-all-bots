...
Kazandığınızda, kazanım oranınıza göre birden fazla ödül alacaksınız.`,
  ...
  if (yourvalue === 21 && dealervalue != 21) {
    if (options.resultEmbed === true) {
      ...
      winEmbed.fields.push({
        name: "Senin elin",
        value: `Kartlar: [\`${yourcards[0].emoji} ${yourcards[0].rank}\`](https://google.com) [\`${yourcards[1].emoji} ${yourcards[1].rank}\`](https://google.com)\nToplam: ${yourvalue}`,
      });
      winEmbed.fields.push({
        name: "Botun eli",
        value: `Kart: [\`${dealercards[0].emoji} ${dealercards[0].rank}\`](https://google.com) [\`${dealercards[1].emoji} ${dealercards[1].rank}\`](https://google.com)\nToplam: ${dealervalue}`,
      });
      commandType === "message"
  ...
  // }
    ...
    if (options.resultEmbed === true) {
      ...
      tieEmbed.fields.push({
        name: "Botun eli",
        value: `Kartlar: [\`${dealercards[0].emoji} ${dealercards[0].rank}\`](https://google.com) [\`${dealercards[1].emoji} ${dealercards[1].rank}\`](https://google.com)\nToplam: ${dealervalue}`,
      });
      commandType === "message"
  ...
  if (options.resultEmbed === true) {
    ...
    finalEmbed.fields.push({
      name: `Senin elin`,
      value: `Kartlar: ${finalResult.ycard.map((c) => `[\`${c.emoji} ${c.rank}\`](https://google.com)`).join(" ")}\nToplam: ${finalResult.ycard.map((card) => card.value).reduce((a, b) => b + a)}`,
      inline: true,
    });
    if (finalResult.ycard2 != null) {
      finalEmbed.fields.push({
        name: `İkinci elin`,
        value: `Kartlar: ${finalResult.ycard2.map((c) => `[\`${c.emoji} ${c.rank}\`](https://google.com)`).join(" ")}\nToplam: ${finalResult.ycard2.map((card) => card.value).reduce((a, b) => b + a)}`,
        inline: true,
      });
    }
    finalEmbed.fields.push({
      name: `Botun eli`,
      value: `Kartlar: ${finalResult.dcard.map((c) => `[\`${c.emoji} ${c.rank}\`](https://google.com)`).join(" ")}\nToplam: ${finalResult.dcard.map((card) => card.value).reduce((a, b) => b + a)}`,
      inline: true,
    });
