      ...
      if (options.isDoubleDown !== true) {
        if (yourvalue > 21 && yourvalue2 > 21) {
          finalResult = {
            ...
            method: `İlk El: Kaybettiniz. Kazanmanız dileğiyle...\nİkinci El: Kaybettiniz. Kazanmanız dileğiyle...`,
            ycard: yourcard,
            ycard2: yourcard2,
            dcard: dealercard,
          };
          ...
          finalResult = {
            ...
            method: `İlk El: Kaybettiniz. Kazanmanız dileğiyle...\nİkinci El:  Blackjack yaparak kazandın.`,
            ycard: yourcard,
            ycard2: yourcard2,
          ...
          finalResult = {
            ...
            method: `İlk El:  Blackjack yaparak kazandın.\nİkinci El: Kaybettiniz. Kazanmanız dileğiyle...`,
            ycard: yourcard,
            ycard2: yourcard2,
            dcard: dealercard,
          };
          ...
          finalResult = {
            ...
            method: `İlk El: Kaybettiniz. Kazanmanız dileğiyle...\nİkinci El: Daha fazla puanla kazandın.`,
            ycard: yourcard,
            ycard2: yourcard2,
            dcard: dealercard,
          };
          ...
          finalResult = {
            ...
            method: `İlk El: Daha fazla puanla kazandın.\nİkinci El: Kaybettiniz. Kazanmanız dileğiyle...`,
            ycard: yourcard,
            ycard2: yourcard2,
            dcard: dealercard,
          };
          ...
          finalResult = {
            result: `SPLIT LOSE-LOSE`,
            method: `İlk El: Kaybettin (Bot, Blackjack yaptı).\nİkinci El: Kaybettin (Bot, Blackjack yaptı).`,
            ycard: yourcard,
            ycard2: yourcard2,
            dcard: dealercard,
          };
          ...
          finalResult = {
            result: `SPLIT LOSE-LOSE`,
            method: `İlk El: Kaybettin (Bot, daha fazlasına sahip).\nİkinci El: Kaybettin (Bot, daha fazlasına sahip).`,
            ycard: yourcard,
            ycard2: yourcard2,
            dcard: dealercard,
          };
        ...
        if (yourvalue > 21 && yourvalue2 > 21) {
          finalResult = {
            ...
            method: `İlk El: Kaybettin (Başarısız) (Çift).\nİkinci El: Kaybettiniz. Kazanmanız dileğiyle...`,
            ycard: yourcard,
            ycard2: yourcard2,
            dcard: dealercard,
          };
          ...
          finalResult = {
            ...
            method: `İlk El: Çifte blackjack yaparak kazandın!\nİkinci El: Kaybettiniz. Kazanmanız dileğiyle...`,
            ycard: yourcard,
            ycard2: yourcard2,
            dcard: dealercard,
          };
          ...
          finalResult = {
            ...
            method: `İlk El: Daha fazla puanla kazandın (Çift).\nİkinci El: Kaybettiniz. Kazanmanız dileğiyle...`,
            ycard: yourcard,
            ycard2: yourcard2,
            dcard: dealercard,
          };
          ...
          finalResult = {
            result: `SPLIT DOUBLE WIN-WIN`,
            method: `İlk El: You won (Bot kaybetti) (Çift).\nİkinci El: Kazandın!`,
            ycard: yourcard,
            ycard2: yourcard2,
            dcard: dealercard,
          };
          ...
          finalResult = {
            result: `SPLIT DOUBLE LOSE-LOSE`,
            method: `İlk El: Kaybettin (Bot, Blackjack yaptı) (Çift).\nİkinci El: Kaybettin (Bot, Blackjack yaptı).`,
            ycard: yourcard,
            ycard2: yourcard2,
            dcard: dealercard,
          };
          ...
          finalResult = {
            result: `SPLIT DOUBLE LOSE-LOSE`,
            method: `İlk El: Kaybettin (Bot, daha fazlasına sahip) (Çift).\nİkinci El: Kaybettin (Bot, daha fazlasına sahip).`,
            ycard: yourcard,
            ycard2: yourcard2,
            dcard: dealercard,
          };
        ...
        if (yourvalue > 21 && yourvalue2 > 21) {
          finalResult = {
            ...
            method: `İlk El: Kaybettiniz. Kazanmanız dileğiyle...\nİkinci El: Kaybettin (Başarısız) (Çift).`,
            ycard: yourcard,
            ycard2: yourcard2,
            dcard: dealercard,
          };
          ...
          finalResult = {
            ...
            method: `İlk El: Kaybettiniz. Kazanmanız dileğiyle...\nİkinci El: Çifte blackjack yaparak kazandın!`,
            ycard: yourcard,
            ycard2: yourcard2,
            ycard2: finalResult2.ycard,
            dcard: dealercard,
          ...
          finalResult = {
            ...
            method: `İlk El: Kaybettiniz. Kazanmanız dileğiyle...\nİkinci El: Daha fazla puanla kazandın (Çift).`,
            ycard: yourcard,
            ycard2: yourcard2,
            dcard: dealercard,
          };
          ...
          finalResult = {
            result: `SPLIT WIN-DOUBLE WIN`,
            method: `İlk El: Kazandın!\nİkinci El: You won (Bot kaybetti) (Çift).`,
            ycard: yourcard,
            ycard2: yourcard2,
            dcard: dealercard,
          };
          ...
          finalResult = {
            result: `SPLIT LOSE-DOUBLE LOSE`,
            method: `İlk El: Kaybettin (Bot, Blackjack yaptı).\nİkinci El: Kaybettin (Bot, Blackjack yaptı) (Çift).`,
            ycard: yourcard,
            ycard2: yourcard2,
            dcard: dealercard,
          };
          ...
          finalResult = {
            result: `SPLIT LOSE-DOUBLE LOSE`,
            method: `İlk El: Kaybettin (Bot, daha fazlasına sahip).\nİkinci El: Kaybettin (Bot, daha fazlasına sahip) (Çift).`,
            ycard: yourcard,
            ycard2: yourcard2,
            dcard: dealercard,
          };
    ...
    if (options.isSplit === "second") {
      ...
      if (options.isDoubleDown !== true) {
        if (yourvalue > 21) {
          ...
          finalResult2 = {
            result: "WIN",
            method: "Daha fazlasına sahipsin",
            ycard: yourcard,
            dcard: dealercard,
          };
        } else if (
          ...
          finalResult2 = {
            result: "LOSE",
            method: "Bot, daha fazlasına sahip",
            ycard: yourcard,
            dcard: dealercard,
          };
      ...
      if (dealervalue === 21 && dealercard.length === 2) {
        if (options.hasInsurance == true) {
          finalResult = {
            ...
            method:
              "Botun blackjack'ine karşı garanti aldınız. Paranız tekrardan size verildi!",
            ycard: yourcard,
            dcard: dealercard,
          };
          if (options.transition === "edit") {
          ...
          finalResult = {
            result: "LOSE",
            method:
              "Kaybettiniz. Kazanmanız dileğiyle... (Bot, Blackjack ile kazandı)",
            ycard: yourcard,
            dcard: dealercard,
          };
          if (options.transition === "edit") {
        ...
        if (options.hasInsurance == true) {
          if (yourvalue > 21) {
            finalResult = {
              ...
              method: "Kaybettiniz. Kazanmanız dileğiyle...",
              ycard: yourcard,
              dcard: dealercard,
            };
          } else if (yourvalue <= 21 && dealervalue < yourvalue) {
            finalResult = {
              ...
              method: "Daha fazla puanla kazandın.",
              ycard: yourcard,
              dcard: dealercard,
            };
          } else if (
            ...
            finalResult = {
              result: "INSURANCE LOSE",
              method: "Kaybettin (Bot, daha fazlasına sahip).",
              ycard: yourcard,
              dcard: dealercard,
            };
          } else if (dealervalue === yourvalue) {
          ...
          if (options.isDoubleDown !== true) {
            ...
            if (yourvalue > 21) {
              ...
              finalResult = {
                result: "DOUBLE WIN",
                method: "Double: Daha fazla puanla kazandın.",
                ycard: yourcard,
                dcard: dealercard,
              };
            } else if (
              ...
              finalResult = {
                result: "DOUBLE LOSE",
                method: "Double: Kaybettin (Bot, daha fazlasına sahip).",
                ycard: yourcard,
                dcard: dealercard,
              };
            } else if (dealervalue === yourvalue) {
