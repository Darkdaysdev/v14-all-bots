...
module.exports = async (channel) => {
  ...
  let entry = await channel.guild
    .fetchAuditLogs({ type: AuditLogEvent.WebhookUpdate })
  ...
  embed.setDescription(
    `${entry.executor} (\`${entry.executor.id}\`) tarafından \`${channel.name}\` kanalında webhook güncellendi ve güncellendiği gibi cezalandırıldı.`,
  );
