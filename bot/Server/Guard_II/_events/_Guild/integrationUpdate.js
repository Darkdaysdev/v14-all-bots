...
module.exports = async (guild) => {
  ...
  let entry = await guild
    .fetchAuditLogs({ type: AuditLogEvent.IntegrationUpdate })
  ...
  embed.setDescription(
    `${entry.executor} (\`${entry.executor.id}\`) tarafından entegrasyonları güncelledi ve güncellendiği gibi cezalandırıldı.`,
  );
