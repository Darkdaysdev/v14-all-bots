...
module.exports = async (guild) => {
  ...
  let entry = await guild
    .fetchAuditLogs({ type: AuditLogEvent.IntegrationDelete })
  ...
  embed.setDescription(
    `${entry.executor} (\`${entry.executor.id}\`) tarafından entegrasyonlar silindi ve silindiği gibi cezalandırıldı.`,
  );
