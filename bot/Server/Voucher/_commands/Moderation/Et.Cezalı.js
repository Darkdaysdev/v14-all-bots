...
module.exports = {
  ...
  onRequest: async function (client, message, args) {
    if (!ayarlar && !roller && !roller.etkinlikCezalıRolü)
    ...
    let jailButton = new ButtonBuilder()
      .setCustomId(`onayla`)
      .setLabel(
        (await ETKINLIK.findById(uye.id))
      ...
      .reply({
        embeds: [
          new genEmbed()
            ...
            .setDescription(
              `Belirtilen ${uye} isimli üyeyi etkinliklerden cezalandırmak istiyor musun?`,
            ),
        ],
        ...
        i.update({
          embeds: [
            new genEmbed()
              ...
              .setDescription(
                `Belirlenen ${uye} isimli üyesini hangi sebep ile etkinliklerden cezalandırmak istiyorsun?`,
              ),
          ],
          components: [
