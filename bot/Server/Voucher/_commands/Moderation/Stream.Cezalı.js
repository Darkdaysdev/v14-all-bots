...
module.exports = {
  ...
  Kullanim: "streamcezalı <@takachi/ID>",
  ...
  onRequest: async function (client, message, args) {
    if (!ayarlar && !roller && !roller.streamerCezalıRolü)
    ...
    const sebeps = [
      ...
      {
        label: "Karşı Cinse Taciz Ve Rahatsız Edici Davranış",
        description: "3 Gün",
        emoji: { name: "2️⃣" },
        value: "2",
        date: "3d",
      ...
      {
        label: "Yayınlarda Pornografi Ve Uygunsuz İçerik Paylaşma",
        description: "7 Gün",
        emoji: { name: "6️⃣" },
        value: "6",
        date: "7d",
      ...
      .reply({
        embeds: [
          new genEmbed()
            ...
            .setDescription(
              `Belirtilen ${uye} isimli üyeyi yayıncı odalarıda cezalandırmak istiyor musun?`,
            ),
        ],
    ...
    collector.on("collect", async (i) => {
        ...
        i.update({
          embeds: [
            new genEmbed()
              ...
              .setDescription(
                `Belirlenen ${uye} isimli üyesini hangi sebep ile yayıncı odalarından cezalandırmak istiyorsun?`,
              ),
          ],
          components: [
      ...
      if (i.customId === `iptal`) {
        ...
        return await i.update({
          content: `${message.guild.emojiGöster(emojiler.Iptal)} ${uye} isimli üyenin **${aktivite}** cezalandırılma işlemi başarıyla iptal edildi.`,
          components: [],
          embeds: [],
          ephemeral: true,
        });
