        ...
        message.reply({
          embeds: [
            new genEmbed()
              ...
              .setDescription(
                `${uye} üyesinin toplamda **${isimveri.Names.length || 0}** isim kayıtı bulundu.\n\n${isimler}`,
              ),
          ],
        });
      } else {
          ...
          let msg = await message.reply({
            embeds: [
              new genEmbed().setDescription(
                `${uye} üyesinin isim kayıtları yükleniyor...`,
              ),
            ],
          });
            ...
            .edit({
              embeds: [
                embed.setDescription(
                  `${uye} üyesinin isim geçmişi yükleniyor...`,
                ),
              ],
              components: [row],
              fetchReply: true,
                ...
                .edit({
                  embeds: [
                    embed
                      ...
                      .setDescription(
                        `${uye} isimli üyesinin toplamda \`${res.Names.length || 0}\` adet isim geçmişi bulunmakta.`,
                      ),
                  ],
                  components: [],
                })
      ...
      message.reply({
        embeds: [
          new genEmbed()
            ...
            .setDescription(`${uye} üyesinin isim kayıtı bulunamadı.`),
        ],
      });
    }
  },
