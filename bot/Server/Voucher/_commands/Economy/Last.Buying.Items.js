...
module.exports = {
  ...
  Kullanim: "envanter <@takachi/ID>",
  Aciklama:
    "Belirlenen veya komutu kullanan kişi belirlediği taglı sayısını ve en son belirlediği taglı sayısını gösterir.",
  Kategori: "eco",
  Extend: true,
  ...
  onRequest: async function (client, message, args) {
    ...
    Users.findOne({ _id: uye.id }, async (err, res) => {
          ...
          .send({
            embeds: [
              new genEmbed()
                ...
                .setDescription(
                  `${uye} isimli üyenin satın alımı bilgisi bulunamadı.`,
                ),
            ],
          })
          .then((x) =>
          ...
          .send({
            embeds: [
              new genEmbed()
                ...
                .setDescription(
                  `${uye} isimli üyenin taglı bilgisi bulunamadı.`,
                ),
            ],
          })
          .then((x) =>
        ...
        .send({
          embeds: [
            embed.setDescription(
              `${uye}, üyesin satın alımı bilgisi yükleniyor... Lütfen bekleyin...`,
            ),
          ],
          components: [row],
          fetchReply: true,
      ...
      await curPage
        .edit({
          embeds: [
            embed.setDescription(`${uye} isimli üyesinin toplamda \`${res.Inventory.length || 0}\` adet satın alımı mevcut.
          ...
          .edit({
            embeds: [
              embed.setFooter({
                ...
                .setDescription(`${uye} isimli üyesinin toplamda \`${res.Inventory.length || 0}\` adet satın alımı mevcut.
            ...
            .edit({
              embeds: [
                embed
                  ...
                  .setDescription(
                    `${uye} isimli üyesinin toplamda \`${res.Inventory.length || 0}\` adet satın alımı mevcut.`,
                  ),
              ],
              components: [],
            })
