...
module.exports = {
  Isim: "transferler",
  Komut: ["transferlerim"],
  Kullanim: "transferler <@takachi/ID>",
  Aciklama:
  ...
  onRequest: async function (client, message, args) {
    ...
    Users.findOne({ _id: uye.id }, async (err, res) => {
          ...
          .send({
            embeds: [
              new genEmbed()
                ...
                .setDescription(
                  `${uye} isimli üyenin transfer bilgisi bulunamadı.`,
                ),
            ],
          })
          .then((x) =>
        ...
        .send({
          embeds: [
            embed.setDescription(
              `${uye}, üyesin transfer bilgisi yükleniyor... Lütfen bekleyin...`,
            ),
          ],
          components: [row],
          fetchReply: true,
      ...
      await curPage
        .edit({
          embeds: [
            embed.setDescription(`${uye} isimli üyesinin toplamda \`${res.Transfers.length || 0}\` adet transferi mevcut.
            ...
            .edit({
              embeds: [
                embed
                  ...
                  .setDescription(
                    `${uye} isimli üyesinin toplamda \`${res.Transfers.length || 0}\` adet transferi mevcut.`,
                  ),
              ],
              components: [],
            })
