...
module.exports = {
  ...
  Kullanim: "taglıbilgisi <@takachi/ID>",
  Aciklama:
  ...
  onRequest: async function (client, message, args) {
    ...
    Users.findOne({ _id: uye.id }, async (err, res) => {
        ...
        .send({
          embeds: [
            embed.setDescription(
              `${uye}, üyesin taglı bilgisi yükleniyor... Lütfen bekleyin...`,
            ),
          ],
          components: [row],
          fetchReply: true,
      ...
      await curPage
        .edit({
          embeds: [
            embed.setDescription(`${uye} isimli üyesinin toplamda \`${res.Taggeds.length || 0}\` adet taglısı mevcut.
            ...
            .edit({
              embeds: [
                embed
                  ...
                  .setDescription(
                    `${uye} isimli üyesinin toplamda \`${res.Taggeds.length || 0}\` adet taglısı mevcut.`,
                  ),
              ],
              components: [],
            })
