  ...
  onRequest: async function (client, message, args, guild) {
    ...
    if (
      ...
      await message.channel.send({
        embeds: [
          embed.setDescription(
            `${message.guild.emojiGöster(emojiler.Iptal)} \`#${message.channel.name}\`  isimli metin kanalına yazmanız kapatıldı.`,
          ),
        ],
      });
    } else {
      ...
      await message.channel.send({
        embeds: [
          embed.setDescription(
            `${message.guild.emojiGöster(emojiler.Onay)} \`#${message.channel.name}\`  isimli metin kanalına yazmanız açıldı.`,
          ),
        ],
      });
    }
