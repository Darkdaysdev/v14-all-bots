...
module.exports = {
  ...
  onRequest: async function (client, message, args) {
    ...
    let victim =
      ...
      (await client.api.users[args[0]].get());
    if (victim.user) {
      victim = {
        id: victim.id,
    ...
    if (!bannerHash)
      return message.channel.send(
        `${cevaplar.prefix} Belirtilen Üyenin Arkaplanı Bulunmadı!`,
      );
    const banner = !bannerHash
      ? `https://images-ext-2.discordapp.net/external/-OXbEcwb-h30h0TQmUM7xCOemMmn4lZeJtZMpSgWMtg/%3Fsize%3D4096/https/cdn.discordapp.com/banners/852681367853465610/a_364822477a2e994552905134288a64b2.gif`
    ...
    let urlButton = new ButtonBuilder()
      ...
      .setStyle("LINK");
    let urlOptions = new ActionRowBuilder().addComponents(urlButton);
