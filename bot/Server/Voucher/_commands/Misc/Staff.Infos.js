      ...
      .then(async (msg) => {
        ...
        collector.on("collect", async (i) => {
          if (i.customId == "testt") {
            ...
            message.channel
              .send(
                `${message.guild.emojiGöster(emojiler.Tag)} Aşağı da **${message.guild.name}** sunucusunun bulunan tüm yetkilileri listelenmektedir. (Yetkili sayısı: **${Aloo ? Aloo.length : 0}**)`,
              )
              .then((x) => {
          ...
          if (i.customId == "aktifseste") {
            ...
            message.channel
              .send(
                `${message.guild.emojiGöster(emojiler.Tag)} Aşağı da aktif fakat seste olmayan **${message.guild.name}** sunucusunun tüm yetkilileri listelenmektedir. (Seste olmayan yetkili sayısı: **${Genel ? Genel.length : 0}**)`,
              )
              .then((x) => {
                const arr = splitMessages(
          ...
          if (i.customId == "toplam") {
            ...
            message.channel
              .send(
                `${message.guild.emojiGöster(emojiler.Tag)} Aşağı da seste olmayan **${message.guild.name}** sunucusunun tüm yetkilileri listelenmektedir. (Seste olmayan yetkili sayısı: **${Genel ? Genel.length : 0}**)`,
              )
              .then((x) => {
                const arr = splitMessages(
                  `${Genel.length >= 1 ? Genel.map((x) => `<@${x}>`).join(", ") : "Tebrikler! Tüm yetkilileriniz seste."}`,
