...
module.exports = {
  ...
  onRequest: async function (client, message, args) {
    ...
    const bannerurl =
      `https://flamingtext.com/net-fu/proxy_form.cgi?imageoutput=true&script=uprise-logo&text=${yazi}`.replace(
        " ",
        "+",
      );
    embed
      .setDescription(`[Oluşturulan Arkaplan İçin TIKLA](${bannerurl})`)
      .setImage(bannerurl);
