...
module.exports = {
  ...
  onRequest: async function (client, message, args) {
    ...
    Users.findOne({ _id: uye.id }, async (err, res) => {
          ...
          .reply({
            embeds: [
              new genEmbed()
                ...
                .setDescription(
                  `${uye} isimli üyenin ilgilenme bilgisi bulunamadı.`,
                ),
            ],
          })
          .then((x) =>
      ...
      const curPage = await message
        .reply({
          embeds: [
            embed.setDescription(
              `${uye}, üyesinin ilgilenme bilgisi yükleniyor... Lütfen bekleyin...`,
            ),
          ],
          components: [row],
          fetchReply: true,
      ...
      await curPage
        .edit({
          embeds: [
            embed.setDescription(`Geçerli olan ilgilenmeler "${message.guild.emojiGöster(emojiler.Onay)}" olarak görülür, geçersiz olanlar ise "${message.guild.emojiGöster(emojiler.Iptal)}" olarak görültülenir.
          ...
          .edit({
            embeds: [
              embed.setFooter({
                ...
                .setDescription(`Geçerli olan ilgilenmeler ${message.guild.emojiGöster(emojiler.Onay)} olarak görülür, geçersiz olanlar ise ${message.guild.emojiGöster(emojiler.Iptal)} olarak görültülenir.
            ...
            .edit({
              embeds: [
                embed
                  ...
                  .setDescription(
                    `${uye} isimli üyesinin toplamda \`${res.Checks.length || 0}\` adet tıklama bilgisi mevcut.`,
                  ),
              ],
              components: [],
            })
